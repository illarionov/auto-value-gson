...
public class AutoValueGsonExtensionTest {
  ...
  public void simple() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", "package test;\n"
        ...
        + "    private volatile TypeAdapter<String> testTypeAdapter__string_adapter;\n"
        + "    private volatile TypeAdapter<List<String>> testListTypeAdapter__list__string_adapter;\n"
        + "    private volatile TypeAdapter<String> testTypeAdapterFactory__string_adapter;\n"
        + "    private volatile TypeAdapter<List<String>> testTypeAdapterFactory__list__string_adapter;\n"
        ...
        + "        jsonWriter.nullValue();\n"
        + "      } else {\n"
        + "        TypeAdapter<String> testTypeAdapter__string_adapter = this.testTypeAdapter__string_adapter;\n"
        + "        if (testTypeAdapter__string_adapter == null) {\n"
        + "          this.testTypeAdapter__string_adapter = testTypeAdapter__string_adapter = new Test.TestTypeAdapter();\n"
        + "        }\n"
        + "        testTypeAdapter__string_adapter.write(jsonWriter, object.k());\n"
        + "      }\n"
        + "      jsonWriter.name(realFieldNames.get(\"l\"));\n"
        + "      if (object.l() == null) {\n"
        + "        jsonWriter.nullValue();\n"
        + "      } else {\n"
        + "        TypeAdapter<List<String>> testListTypeAdapter__list__string_adapter = this.testListTypeAdapter__list__string_adapter;\n"
        + "        if (testListTypeAdapter__list__string_adapter == null) {\n"
        + "          this.testListTypeAdapter__list__string_adapter = testListTypeAdapter__list__string_adapter = new Test.TestListTypeAdapter();\n"
        + "        }\n"
        + "        testListTypeAdapter__list__string_adapter.write(jsonWriter, object.l());\n"
        + "      }\n"
        + "      jsonWriter.name(realFieldNames.get(\"m\"));\n"
        + "      if (object.m() == null) {\n"
        + "        jsonWriter.nullValue();\n"
        + "      } else {\n"
        + "        TypeAdapter<String> testTypeAdapterFactory__string_adapter = this.testTypeAdapterFactory__string_adapter;\n"
        + "        if (testTypeAdapterFactory__string_adapter == null) {\n"
        + "          this.testTypeAdapterFactory__string_adapter = testTypeAdapterFactory__string_adapter = new Test.TestTypeAdapterFactory().create(gson, TypeToken.get(String.class));\n"
        + "        }\n"
        + "        testTypeAdapterFactory__string_adapter.write(jsonWriter, object.m());\n"
        + "      }\n"
        + "      jsonWriter.name(realFieldNames.get(\"n\"));\n"
        + "      if (object.n() == null) {\n"
        + "        jsonWriter.nullValue();\n"
        + "      } else {\n"
        + "        TypeAdapter<List<String>> testTypeAdapterFactory__list__string_adapter = this.testTypeAdapterFactory__list__string_adapter;\n"
        + "        if (testTypeAdapterFactory__list__string_adapter == null) {\n"
        + "          this.testTypeAdapterFactory__list__string_adapter = testTypeAdapterFactory__list__string_adapter = (TypeAdapter<List<String>>) new Test.TestTypeAdapterFactory().create(gson, TypeToken.getParameterized(List.class, String.class));\n"
        + "        }\n"
        + "        testTypeAdapterFactory__list__string_adapter.write(jsonWriter, object.n());\n"
        + "      }\n"
        ...
        + "                this.testTypeAdapter__string_adapter = testTypeAdapter__string_adapter = new Test.TestTypeAdapter();\n"
        + "              }\n"
        + "              k = testTypeAdapter__string_adapter.read(jsonReader);\n"
        + "              continue;\n"
        + "            }\n"
        ...
        + "                this.testListTypeAdapter__list__string_adapter = testListTypeAdapter__list__string_adapter = new Test.TestListTypeAdapter();\n"
        + "              }\n"
        + "              l = testListTypeAdapter__list__string_adapter.read(jsonReader);\n"
        + "              continue;\n"
        + "            }\n"
        ...
        + "                this.testTypeAdapterFactory__string_adapter = testTypeAdapterFactory__string_adapter = new Test.TestTypeAdapterFactory().create(gson, TypeToken.get(String.class));\n"
        + "              }\n"
        + "              m = testTypeAdapterFactory__string_adapter.read(jsonReader);\n"
        + "              continue;\n"
        + "            }\n"
        ...
        + "                this.testTypeAdapterFactory__list__string_adapter = testTypeAdapterFactory__list__string_adapter = (TypeAdapter<List<String>>) new Test.TestTypeAdapterFactory().create(gson, TypeToken.getParameterized(List.class, String.class));\n"
        + "              }\n"
        + "              n = testTypeAdapterFactory__list__string_adapter.read(jsonReader);\n"
        + "              continue;\n"
        + "            }\n"
